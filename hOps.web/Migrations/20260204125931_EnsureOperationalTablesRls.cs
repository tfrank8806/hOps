...
{
    /// <inheritdoc />
    public partial class EnsureOperationalTablesRls : Migration
    {
        private static readonly string[] Tables =
        {
            "BookmarkSectionGroups",
            "BookmarkSectionAssignments",
            "PreventiveMaintenanceSessions",
            "PreventiveMaintenanceSettings",
            "PreventiveMaintenanceTasks",
            "PreventiveMaintenanceSessionTasks",
            "DeepCleanChecklistItems",
            "DeepCleanSessions",
            "DeepCleanSettings",
            "DeepCleanSessionTasks"
        };
