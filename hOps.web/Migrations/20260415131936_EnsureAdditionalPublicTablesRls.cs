...
{
    /// <inheritdoc />
    public partial class EnsureAdditionalPublicTablesRls : Migration
    {
        private static readonly string[] Tables =
        {
            "AttendanceRecords",
            "SupplyInventorySnapshots",
            "SupplyInventoryStates",
            "MaintenanceLogCycleCompletions",
            "MaintenanceLogCompletionAttachments",
